...
<div class="dog-food">
    ...
    <div class="content">
        ...
        <a href="products.php"> <img src="image/shop_now_dog.png" alt=""> </a>
    </div>
...
<div class="cat-food">
    ...
    <div class="content">
        ...
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat iure illo, repudiandae rem porro sunt.</p>
        <div class="amount">$15.00 - $30.00</div>
        <a href="products.php"> <img src="image/shop_now_cat.png" alt=""> </a>
    </div>
...
<section class="shop" id="shop">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="icons">
                <a href="products.php" class="fas fa-shopping-cart"></a>
                <a href="" class="fas fa-heart"></a>
                <a href="products.php" class="fas fa-eye"></a>
            </div>
            <div class="image">
...
<section class="contact" id="contact">
    ...
    <form action="comment.php" method="post">
        ...
        <input type="tumber" name="number" placeholder="your number" class="box">
...
<section class="footer">
    ...
    <div class="credit"> created by <span> MD Mruf Ul Islam </span> | all rights reserved! </div>
